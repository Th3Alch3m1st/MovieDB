...
import com.neugelb.movies.ScrollToBottomAction
import com.neugelb.testutil.uitest.launchFragmentInHiltContainer
...
class SearchMoviesFragmentTest {
	...
	@Inject
	lateinit var fakeRemoteSource: FakeMovieSearchRemoteSourceImpl
    ...
    */
	...
	fun test_emptyResponse_displayed() {
		...
		onView(withId(androidx.appcompat.R.id.search_src_text))
			.perform(
				ViewActions.typeText(FakeMovieSearchRemoteSourceImpl.TRIGGERED_EMPTY_RESPONSE),
		...
		onView(withId(com.neugelb.core.R.id.tv_title))
			.check(matches(withText(FakeMovieSearchRemoteSourceImpl.MSG_EMPTY)))
		onView(withId(com.neugelb.core.R.id.btn_try_again))
			.check(matches(not(isDisplayed())))
	...
	fun test_errorResponse_displayed() {
		...
		onView(withId(com.neugelb.core.R.id.tv_title))
			.check(matches(isDisplayed()))
		onView(withId(com.neugelb.core.R.id.tv_title))
			.check(matches(withText(FakeMovieSearchRemoteSourceImpl.MSG_ERROR)))
		onView(withId(com.neugelb.core.R.id.btn_try_again))
			.check(matches(isDisplayed()))
	}
	...
	fun test_errorResponse_displayed_retry_should_fetch_data() {
		...
		onView(withId(com.neugelb.core.R.id.btn_try_again)).perform(click())
		...
		onView(withId(R.id.rv_search_result)).check { view, noViewFoundException ->
			...
			val recyclerView = view as RecyclerView
			Assert.assertEquals(FakeMovieSearchRemoteSourceImpl.PAGE_SIZE, recyclerView.adapter?.itemCount)
		}
	}
    ...
    */
	...
	fun test_afterInitialLoadingErrorHappen_ErrorItemDisplayed() {
		...
		//verifying cases
		onView(withId(R.id.rv_search_result))
			.check(matches(hasDescendant(withId(com.neugelb.core.R.id.layout_state))))
		onView(withId(com.neugelb.core.R.id.btn_paging_retry)).check(matches(isDisplayed()))
		onView(withId(com.neugelb.core.R.id.tv_paging_error_msg)).check(matches(isDisplayed()))
		onView(withId(com.neugelb.core.R.id.progress_bar_rv))
			.check(matches(not(isDisplayed())))
	}
	...
	*/
	...
	fun test_afterInitialLoadingErrorHappen_retryToLoadList() {
		...
		onView(withId(com.neugelb.core.R.id.btn_paging_retry)).perform(click())
		onView(withId(R.id.rv_search_result)).perform(ScrollToBottomAction())

		Thread.sleep(WAIT_TIME)
		//validating cases
		onView(withId(R.id.rv_search_result))
			.check(matches(not(hasDescendant(withId(com.neugelb.core.R.id.btn_paging_retry)))))
		onView(withId(R.id.rv_search_result))
			.check(matches(not(hasDescendant(withId(com.neugelb.core.R.id.tv_paging_error_msg)))))
		onView(withId(R.id.rv_search_result))
			.check(matches(not(hasDescendant(withId(com.neugelb.core.R.id.progress_bar_rv)))))
	}
