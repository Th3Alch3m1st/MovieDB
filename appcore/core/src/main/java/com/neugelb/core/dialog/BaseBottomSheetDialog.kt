package com.neugelb.core.dialog
...
import com.neugelb.themes.R
import com.neugelb.core.fragment.FragmentCommunicator
import com.neugelb.core.util.autoCleared
...
abstract class BaseBottomSheetDialog<DataBinding : ViewDataBinding> : BottomSheetDialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        dialog.setOnShowListener {
            ...
            sheet?.let { view ->
                if(bottomSheetBehavior == BottomSheetBehavior.STATE_EXPANDED){
